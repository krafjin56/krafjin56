...
- #### 현재는 빅테이터분석 개발자 과정을 수강하며 기술스택을 확장해 서버와 백엔드 영역까지 개발가능한 풀스택 개발자
#### 로 또한번 상상을 구체화 시켜 보고싶습니다.
- #### 무엇보다 하나에 빠지면 그분야를 끝까지 파버리는 몰두형 사람이라 현재는 java와 javascript에 미쳐
#### 앞으로 더욱더 높은 퀄리티의 아웃풋을 만들어 내고 싶습니다.
